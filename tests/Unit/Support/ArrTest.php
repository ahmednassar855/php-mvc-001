...
class ArrTest extends TestCase
{
    ...
    public function test_it_flattens_only_for_a_given_depth()
    {
        $nestedRepeatedNumbers = [
            1,[2,[3,[4,[5]]]] , 6
        ];
        $this->assertSame([1, 2, 3, [4, [5]], 6], Arr::flatten($nestedRepeatedNumbers,2));
    }


    public function test_it_flattens_only_for_a_given_depth3()
    {
        $nestedRepeatedNumbers = [
            1,[2,[3,[4,[5]]]] , 6
        ];
        $this->assertSame([1, 2, 3, 4, [5], 6], Arr::flatten($nestedRepeatedNumbers,3));
    }
